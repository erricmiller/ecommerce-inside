...
const digitalmarketing: NextPage = () => {
  ...
  return (
    <>
      <Header />
      <Banner
        mainHeading={"Exceptional Digital Marketing Services in USA"}
        bgImg={"/branding-banner.webp"}
        img={"/digital-banner-right.webp"}
        desc={
          "Ecommerce Inside is a one-stop platform for all your marketing needs. Our strategies and teams work dedicatedly to bring your brand on top."
        }
      />
      <ServicesContact />
      <section>
