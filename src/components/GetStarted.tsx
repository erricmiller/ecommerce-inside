      ...
      <div className="container mx-auto px-[10px]">
        <div className="row flex flex-col lg:flex-row gap-8">
          ...
          <div className="getStartedRight relative lg:max-w-[50%]">
            <h3 className="GetStartedHeading text-[30px] font-bold text-white lg:text-[40px] 3xl:text-[50px] before:hidden lg:before:block  lg:before:bg-[url('/footer-right-circle.webp')] before:w-[794px] before:h-[806px] before:-top-[220px] before:-right-[350px] before:absolute bg-no-repeat before:animate-circle-spin ">
              Let's Get Started!
            </h3>
